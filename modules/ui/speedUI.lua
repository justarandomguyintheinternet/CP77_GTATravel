...
function speedUI.draw(gtaTravel)
    ...
    ImGui.BeginChild("upSettings", speedUI.boxSize.x, 150, true)
    ImGui.Text("Upward Path Settings")
    gtaTravel.CPS.colorEnd(1)
    ImGui.Separator()
    ImGui.PushItemWidth(330)
        
    gtaTravel.settings.upwardPath.topSpeed = ImGui.SliderFloat("Max Speed", gtaTravel.settings.upwardPath.topSpeed, 0.5, 25, "%.2f")
    ...
    gtaTravel.settings.upwardPath.playerTpDistance = ImGui.SliderInt("Player TP Dist.", gtaTravel.settings.upwardPath.playerTpDistance, 1, 175)
    ...
    ------------------------------------------------------------------------------
    gtaTravel.CPS.colorBegin("Text", speedUI.colors.frame)
    ImGui.BeginChild("sideSettings", speedUI.boxSize.x, 100, true)
    ImGui.Text("Sideways Path Settings")
    ImGui.Separator()
    gtaTravel.CPS.colorEnd(1)
    ImGui.PushItemWidth(330)
        
    gtaTravel.settings.sidePath.topSpeed = ImGui.SliderFloat("Max Speed", gtaTravel.settings.sidePath.topSpeed, 1, 75, "%.2f")
    speedUI.tooltips.drawBtn(gtaTravel, "?", "topSpeed")
    gtaTravel.settings.sidePath.speedIncrement = ImGui.SliderFloat("Speed Increment", gtaTravel.settings.sidePath.speedIncrement, 0.0005, 1, "%.3f")
    speedUI.tooltips.drawBtn(gtaTravel, "?", "speedIncrement")
    ...
    ------------------------------------------------------------------------------
    gtaTravel.CPS.colorBegin("Text", speedUI.colors.frame)
    ImGui.BeginChild("downSettings", speedUI.boxSize.x, 125, true)
    ImGui.Text("Downward Path Settings")
    gtaTravel.CPS.colorEnd(1)
    ImGui.Separator()
    ImGui.PushItemWidth(330)
        
    gtaTravel.settings.downPath.topSpeed = ImGui.SliderFloat("Max Speed", gtaTravel.settings.downPath.topSpeed, 0.5, 25, "%.2f")
    speedUI.tooltips.drawBtn(gtaTravel, "?", "topSpeed")

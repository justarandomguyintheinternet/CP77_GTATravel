...
function helpUI.draw(gtaTravel)
    ...
    gtaTravel.CPS.colorBegin("Text", speedUI.colors.frame)
    ImGui.BeginChild("help3", speedUI.boxSize.x, 110, true)
    ImGui.Text("Other issues")
    gtaTravel.CPS.colorEnd(1)
    ImGui.Separator()
    
    ImGui.TextWrapped("- If you can see the players head after the transition you can toggle him in the misc settings, or just disable the head during transition completely")

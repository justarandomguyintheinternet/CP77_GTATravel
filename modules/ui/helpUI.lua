...
function helpUI.draw(gtaTravel)
    ...
    ------------------------------------------------------------------------------
    ImGui.BeginChild("help1", speedUI.boxSize.x, 140, true)
    ...
    gtaTravel.CPS.colorBegin("Text", speedUI.colors.frame)
    ImGui.BeginChild("help2", speedUI.boxSize.x, 195, true)
    ...
    gtaTravel.CPS.colorBegin("Text", speedUI.colors.frame)
    ImGui.BeginChild("help3", speedUI.boxSize.x, 80, true)
    ImGui.Text("Other issues")
    gtaTravel.CPS.colorEnd(1)
    ImGui.Separator()

    ImGui.TextWrapped("- If you want a smoother motion that is less linear lower the speed increment / play around with that value")
    ImGui.EndChild()
